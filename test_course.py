...
def test_find_a_course(arranged_course_manager, arranged_teacher_list):
    # arrange
    new_course_id = arranged_course_manager.create_a_course(
        "COSC 381", "W24", arranged_teacher_list
    )
...
def test_create_a_course(mocker, arranged_course_manager, arranged_teacher_list):
    ...
    # assert
    mocked_create_a_course.assert_called_with("COSC 381", "W24", arranged_teacher_list)import pytest
